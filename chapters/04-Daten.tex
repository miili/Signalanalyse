...
Der Trend kann auch mittels Filterung oder eines \textsl{Moving Average} (gleitendes Mittel, MA) bestimmt werden. Wird ein akausales, zweiseitiges Fenster verwendet:
\begin{equation}
